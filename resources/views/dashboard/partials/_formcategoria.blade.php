        ...
        <section class="row 6">
            ...
            <article class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> <!-- si -->
                <div class="form-floating mb-3">
                    <input type="text" name="NombreCategoria" class="form-control form-floating mb-3" placeholder="Nombre" value="{{$categoria->NombreCategoria}}">
                ...
                <center>
                    ...
                    <a href="{{route('categorias.index')}}" class="btn btn-outline-info mt-3 btn-lg"><h4>Regresar</h4></a>
